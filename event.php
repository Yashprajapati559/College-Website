				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
								<h3 class="event-title"><a href="fest galary1.php">Sports Week 2023</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
									<h3 class="event-title"><a href="fest galary2.php">GECB Fest 2023</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
									<h3 class="event-title"><a href="fest galary3.php">Sports Week 2024</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
									<h3 class="event-title"><a href="fest galary4.php">GECB Fest 2024</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
								<h3 class="event-title"><a href="fest galary5.php">E-sports event 2025</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						...
						<div class="single-event">
							...
							<div class="event-content">
									<h3 class="event-title"><a href="fest galary6.php">E-Sports event 2026</a></h3>
							</div>
						</div>
						<!-- End Single Event -->
					</div>
