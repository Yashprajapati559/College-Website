				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
							...
							<li class="active"><a href="#">Canteen<i class="fa fa-angle-right"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="row">
					<div class="col-lg-6 offset-lg-3 col-12">
						<div class="section-title bg">
							...
							<q style="font-size: 20px; font-family: serif; align-content:center;">Our college got hyginic and fresh canteen food.<br> Our canteen got a dining area and the sanitation of canteen is personalyy taken care by the workers</q>
						</div>
					</div>
				</div>
