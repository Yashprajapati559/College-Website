				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
							...
							<li><a href="#">Campus Tour<i class="fa fa-angle-right"></i></a></li>
							<li class="active"><a href="#">Medical facility<i class="fa fa-angle-right"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="row">
					<div class="col-lg-6 offset-lg-3 col-12">
						<div class="section-title bg">
							...
							<q style="font-size: 20px; font-family: serif; align-content:center;">Our college got the best government medical facilities with certified government doctors in our campus.<br> Which deal from minor injuries to major accidents for free of cost.</q>
						</div>
					</div>
				</div>
