				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
							...
							<li><a href="Events.php">Events<i class="fa fa-angle-right"></i></a></li>
							<li class="active"><a href="#">GECB fest 2024<i class="fa fa-angle-right"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
