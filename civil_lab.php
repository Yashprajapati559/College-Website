				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-12">
						<ul class="bread-list">
							...
							<li><a href="event.php">Campus tour<i class="fa fa-angle-right"></i></a></li>
							<li class="active"><a href="#">Civil Laboratory<i class="fa fa-angle-right"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
